...
class SubscriptionModelAdmin(admin.ModelAdmin):
    ...
    actions = ['mark_as_paid'] # Criar uma action no admin
    ...
    def mark_as_paid(self, request, queryset):# Criar uma action no admin
    ...
    mark_as_paid.short_description = 'Marcar como pago'# Criar uma action no admin
