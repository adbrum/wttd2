...
class TalkListGet(TestCase):
    def setUp(self):
        ...
        speaker = Speaker.objects.create(name='Adriano Regis',
                                         slug='adriano-regis',
                                         website='http://adrianoregis.com')

        t1.speakers.add(speaker)  # add adiciona a relação manytomany.
